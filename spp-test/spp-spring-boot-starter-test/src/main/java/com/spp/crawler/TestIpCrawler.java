 ...
 */
@ProxyIpCrawler
public interface TestIpCrawler {
    ...
    @ProxyIpCrawler(key = "kuaidaili", name = "快代理",
            ...
            headRowIndex = -1, ipIndex = 0, portIndex = 1, cityIndex = 5,
    ...
    @ProxyIpCrawler(key = "zdaye", name = "站大爷",
            ...
            ipIndex = 0, portIndex = 1, cityIndex = 3, cityNameParser = CityValueCnStyle3Parser.class)
    public void zdaye();
    ...
    @ProxyIpCrawler(key = "kxdaili", name = "开心代理",
            ...
            rowsSelector = "table tbody tr", cellSelector = "td",
            ipIndex = 0, portIndex = 1, cityIndex = 5, cityNameParser = CityValueCnStyle3Parser.class,
            lock = true)
    public void kxdaili();
    ...
    @ProxyIpCrawler(key = "ip3366", name = "云代理",
            ...
            cityIndex = 4, cityNameParser = CityValueCnStyle2Parser.class,
            lock = true)
    public void ip3366();
    ...
    @ProxyIpCrawler(key = "ihuan", name = "小幻代理",
            ...
            cityNameParser = CityValueCnStyle2Parser.class,
            lock = true)
    public void ihuan();
    ...
    @ProxyIpCrawler(key = "89ip", name = "89代理",
            ...
            cityNameParser = CityValueCnStyle3Parser.class,
            lock = true)
    public void _89ip();
    ...
    @ProxyIpCrawler(key = "free-proxy", name = "新鲜代理",
            ...
            ipValueParser = Base64Parser.class,
            cityIndex = 5, cityNameParser = CityValueCnPinyinParser.class,
            lock = true)
